  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="cursor-pointer px-2 sm:px-4 text-description transition-colors hover:text-description/80">
          <IoPersonCircleSharp className="text-3xl sm:text-4xl"/>
        </Button>
      </DialogTrigger>
      <DialogContent>
