...
async function PersonalLayout({ children }: Props) {
  ...
  return (
    <main className="h-full min-h-full w-full ">
      <div className="relative lg:flex w-full h-full bg-body">
        <div className=" w-full p-4 flex lg:hidden lg:items-center justify-center overflow-hidden lg:rounded-2xl text-xl font-bold text-[#998D73]">
          
          <div className="flex flex-col justify-center m-2 w-[20%] md:w-[30%] ">
            <div className="mb-3 md:mb-5 text-center"> Topic </div>
            <div className="mb-3 md:mb-5 flex h-[30%] lg:h-[50%] w-full items-center justify-center rounded-2xl bg-[#D8D2C7] ">
              {" "}
              {subject.subject}{" "}
            </div>
            <div className="mb-3 md:mb-5 text-center"> Complete </div>
            <div className="flex h-[30%] lg:h-[50%] w-full items-center justify-center rounded-2xl bg-[#D8D2C7]">
              {" "}
        ...
        <div className="w-full lg:w-3/4 flex flex-wrap  overflow-y-auto px-24 md:px-36 lg:px-8 py-6 bg-body">
          {children}
        </div>
